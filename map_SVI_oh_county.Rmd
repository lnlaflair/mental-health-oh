...
packages <- c("dplyr", "forcats", "plotly", "stringr", "tidyr", "data.table", "purrr", "kableExtra", "flextable", "plotly", "unikn", "leaflet", "leaflegend", "leaflet.extras", "sf", "censusapi", "tidycensus", "tigris")
...
svi_map <- county_merged_svi %>%
  ...
  addPolygons(data = county_merged_svi, 
             fillColor = ~mypalette(county_merged_svi$svi), 
             fillOpacity = 0.7, 
             weight = 0.2, 
             smoothFactor = 0.2, 
...
imr_map <- county_merged_imr %>%
  ...
  addPolygons(data = county_merged_imr, 
             fillColor = ~mypalette(county_merged_imr$rate), 
             fillOpacity = 0.7, 
             weight = 0.2, 
             smoothFactor = 0.2, 
  ...
  addLabelOnlyMarkers(
   ...
   addLegend(pal = mypalette, 
          ...
          position = "bottomleft", 
          title = "Infant Mortality Rate, 2017-2021") %>% 
  leaflet.extras::setMapWidgetStyle(list(background= "transparent")) %>%
   leaflet.extras::addResetMapButton()
...
fins_map <- county_merged_fins %>%
  ...
  addPolygons(data = county_merged_fins, 
             fillColor = ~mypalette(county_merged_fins$percent), 
             fillOpacity = 0.7, 
             weight = 0.2, 
             smoothFactor = 0.2, 
  ...
  addLabelOnlyMarkers(
   ...
   addLegend(pal = mypalette, 
          ...
          position = "bottomleft", 
          title = "Percent Food Insecure, 2019") %>% 
  leaflet.extras::setMapWidgetStyle(list(background= "transparent")) %>%
   leaflet.extras::addResetMapButton()
...
mhprov_map <- county_merged_mhprov %>%
  ...
  addPolygons(data = county_merged_mhprov, 
             fillColor = ~pal(county_merged_mhprov$ratio), 
             fillOpacity = 0.7, 
             weight = 0.2, 
             smoothFactor = 0.2, 
  ...
  addLabelOnlyMarkers(
   ...
   addLegend(pal = pal, 
          ...
          position = "bottomleft", 
          title = "Ratio: population to mental health providers<br />per 100,000 population<br/> 2021") %>% 
  leaflet.extras::setMapWidgetStyle(list(background= "transparent")) %>%
   leaflet.extras::addResetMapButton()
...
suic_map <- county_merged_suic %>%
  ...
  addPolygons(data = county_merged_suic, 
             fillColor = ~pal(county_merged_suic$rate), 
             fillOpacity = 0.7, 
             weight = 0.2, 
             smoothFactor = 0.2, 
  ...
  addLabelOnlyMarkers(
   ...
   addLegend(pal = pal, 
          ...
          position = "bottomleft", 
          title = "Number of Suicides<br />per 100,000 population<br/>2020-2021") %>% 
  leaflet.extras::setMapWidgetStyle(list(background= "transparent")) %>%
   leaflet.extras::addResetMapButton()
...
od_map <- county_merged_od %>%
  ...
  addPolygons(data = county_merged_od, 
             fillColor = ~pal(county_merged_od$rate), 
             fillOpacity = 0.7, 
             weight = 0.2, 
             smoothFactor = 0.2, 
  ...
  addLabelOnlyMarkers(
   ...
   addLegend(pal = pal, 
          ...
          position = "bottomleft", 
          title = "Number of Unintentional Overdose Deaths<br />per 100,000 population<br/> 2020-2021") %>% 
  leaflet.extras::setMapWidgetStyle(list(background= "transparent")) %>%
   leaflet.extras::addResetMapButton()
